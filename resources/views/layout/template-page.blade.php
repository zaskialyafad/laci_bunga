        ...
        <div class="row">
          <div class="col-md-6 d-flex flex-wrap">
            ...
            <div class="payment-option">
              ...
              <img src="{{ asset('/') }}assets/img/page/visa-card.png" alt="card">
              <img src="{{ asset('/') }}assets/img/page/paypal-card.png" alt="card">
              <img src="{{ asset('/') }}assets/img/page/master-card.png" alt="card">
            </div>
          </div>
