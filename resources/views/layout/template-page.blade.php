...
<body class="homepage">
 ...
 {{-- Search Popup  --}}
    ...
    {{-- NAVBAR UTAMA --}}
          <nav class="navbar navbar-expand-lg bg-light text-uppercase fs-6 p-3 border-bottom align-items-center fixed-top" style="background-color: #f8f9fa !important;">        <div class="container-fluid">
...
<!-- End of Main Content -->
  ...
  <footer id="footer" class="mt-5">
      ...
      <div class="row d-flex flex-wrap justify-content-between py-5">
          ...
          <div class="footer-menu footer-menu-001">
            <div class="footer-intro mb-4">
              <a href="{{ route('web.home-page') }}">
                <img src="{{ asset('/') }}assets/img/page/main-logo.png" class="img-fluid" alt="logo ">
              </a>
            </div>
            <p>Buka laci penuh dengan bunga.</p>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-004 border-animation-left">
            ...
            <p>Do you have any questions or suggestions? <a href="mailto:zaskialyafadilah@upi.edu"
                class="item-anchor">zaskialyafadilah@upi.edu</a></p>
            <p>Do you need support? Give us a call. <a href="+62 812 3456 789" class="item-anchor">+62 812 3456 789 (nomor fiksi)</a>
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="copyright text-center my-auto">
      <span>Copyright &copy; Laci Bunga 2025</span>
    </div>
  </footer>
